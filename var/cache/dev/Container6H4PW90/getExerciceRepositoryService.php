...
class getExerciceRepositoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Repository/ExerciceRepository.php';

        return $container->privates['App\\Repository\\ExerciceRepository'] = new \App\Repository\ExerciceRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
