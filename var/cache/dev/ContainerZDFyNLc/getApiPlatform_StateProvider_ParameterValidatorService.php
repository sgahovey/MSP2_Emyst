...
class getApiPlatform_StateProvider_ParameterValidatorService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $f = new \ApiPlatform\State\Provider\DeserializeProvider(new \ApiPlatform\State\Provider\SecurityParameterProvider(new \ApiPlatform\Symfony\Security\State\AccessCheckerProvider(new \ApiPlatform\Symfony\Bundle\SwaggerUi\SwaggerUiProvider($c, ($container->privates['api_platform.openapi.factory'] ?? $container->load('getApiPlatform_Openapi_FactoryService'))), $e), $e), ($container->privates['serializer'] ?? self::getSerializerService($container)), $b, NULL);
        if ($container->has('debug.stopwatch')) {
            $f->setStopwatch($d);
        }
