...
class getSeanceExerciceRepositoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SeanceExerciceRepository.php';

        return $container->privates['App\\Repository\\SeanceExerciceRepository'] = new \App\Repository\SeanceExerciceRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
